...
public class SSHExecutor {
    ...
    private SSHExecutor(SSHInfo sshInfo,String keyFile) throws JSchException {
        jsch = new JSch();
    ...
    public static SSHExecutor newInstance() throws JSchException {
        SSHInfo sshInfo = new SSHInfo("root", "123456", "172.17.10.9", 22);
     ...
     * @throws JSchException
     */
    public static SSHExecutor newInstanceKey() throws JSchException {
        SSHInfo sshInfo = new SSHInfo("chenxiao", "RXIN7K2uWFeoCjZy", "210.14.152.199", 12330);
        String keyFile = "D:\\lzgit\\demo\\src\\main\\resources\\chenxiao.pem";
        return new SSHExecutor(sshInfo,keyFile);
    }
