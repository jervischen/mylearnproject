...
public class EncryptUtils {
     ...
     * 密钥
     */
    private static final String KEY = "ppyw2021777777h5";// AES加密要求key必须要128个比特位（这里需要长度为16，否则会报错）
    ...
    public static void main(String[] args) throws Exception {
        String content = "2EBAF7O2sLCe3bkJXiJRPv8GnsfDk5SV";
